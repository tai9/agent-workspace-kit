...
market-researcher, product-owner, conversion-audit) carry the *method*:
...
| `prior-findings.md` | What has been measured, tried, reverted, or deliberately decided; which recorded numbers are stale | all five |
